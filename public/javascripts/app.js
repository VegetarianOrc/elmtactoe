...
var _user$project$Models$isSameSpace = F2(
	function (b1, b2) {
		return _elm_lang$core$Native_Utils.eq(b1.content, b2.content);
	});
var _user$project$Models$spaceContains = F2(
	function (space, point) {
		var inBounds = F3(
			function (min, max, val) {
				return (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$Basics$toFloat(min),
					val) < 0) && (_elm_lang$core$Native_Utils.cmp(
					val,
					_elm_lang$core$Basics$toFloat(max)) < 0);
			});
		var maxY = space.y + space.width;
		var maxX = space.x + space.width;
		var _p0 = point;
		var pointX = _p0._0;
		var pointY = _p0._1;
		return A3(inBounds, space.x, maxX, pointX) && A3(inBounds, space.y, maxY, pointY);
	});
var _user$project$Models$BoardSpace = F4(
	function (a, b, c, d) {
		return {x: a, y: b, width: c, content: d};
	});
var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {nextMove: a, board: b, winner: c};
	});
var _user$project$Models$Circle = {ctor: 'Circle'};
var _user$project$Models$Cross = {ctor: 'Cross'};
var _user$project$Models$Empty = {ctor: 'Empty'};
var _user$project$Models$makeRow = F2(
	function (yValue, width) {
		var makeBoardSpace = function (index) {
			return {x: index * width, y: yValue, width: width, content: _user$project$Models$Empty};
		};
		return A2(
			_elm_lang$core$List$map,
			makeBoardSpace,
...
var _user$project$Models$init = function () {
	...
	var helper = function (index) {
		return A2(_user$project$Models$makeRow, index * cellWidth, cellWidth);
	};
	var board = A2(
		_elm_lang$core$List$map,
		helper,
	...
	var initialModel = {nextMove: _user$project$Models$Cross, board: board, winner: _elm_lang$core$Maybe$Nothing};
	return {ctor: '_Tuple2', _0: initialModel, _1: _elm_lang$core$Platform_Cmd$none};
}();
var _user$project$Models$ReceiveSVGCoords = function (a) {
	return {ctor: 'ReceiveSVGCoords', _0: a};
};
var _user$project$Models$OnTouch = function (a) {
	return {ctor: 'OnTouch', _0: a};
};

var _user$project$Update$detectWinner = function (model) {
	var diag2 = function () {
		var ele3 = A2(
			...
			A2(
				...
				_elm_lang$core$List$head(model.board)));
		var ele2 = A2(
			_elm_lang$core$Maybe$andThen,
			_elm_lang$core$List$head,
			A2(
				...
				_elm_lang$core$List$head(
					A2(_elm_lang$core$List$drop, 1, model.board))));
		var ele1 = A2(
			_elm_lang$core$Maybe$andThen,
			_elm_lang$core$List$head,
			_elm_lang$core$List$head(
				A2(_elm_lang$core$List$drop, 2, model.board)));
	...
	var getColumn = function (index) {
		return _elm_community$maybe_extra$Maybe_Extra$values(
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					_elm_lang$core$List$drop(index),
					model.board)));
	};
	var isAllSameMove = F2(
		function (spaces, move) {
			return A2(
				_elm_lang$core$List$all,
				function (n) {
					return _elm_lang$core$Native_Utils.eq(n, move);
				},
				A2(
					_elm_lang$core$List$map,
					function (_) {
	...
	var isWinner = function (spaces) {
		var winner = A2(isAllSameMove, spaces, _user$project$Models$Cross) || A2(isAllSameMove, spaces, _user$project$Models$Circle);
		return {ctor: '_Tuple2', _0: winner, _1: spaces};
	};
	var rows = A2(_elm_lang$core$List$map, isWinner, model.board);
	var columns = A2(
		_elm_lang$core$List$map,
		isWinner,
		A2(
...
var _user$project$Update$updateRow = F3(
	function (point, nextContent, row) {
		var updateSpaceIfNeeded = function (space) {
			if (A2(_user$project$Models$spaceContains, space, point)) {
				var _p0 = space.content;
				if (_p0.ctor === 'Empty') {
					return {
						ctor: '_Tuple2',
						_0: true,
					...
					return {ctor: '_Tuple2', _0: false, _1: space};
				}
			} else {
				return {ctor: '_Tuple2', _0: false, _1: space};
			}
		...
		var _p1 = _elm_lang$core$List$unzip(
			A2(_elm_lang$core$List$map, updateSpaceIfNeeded, row));
		var updateStatuses = _p1._0;
		var spaces = _p1._1;
		var didUpdate = A3(
			_elm_lang$core$List$foldl,
			F2(
			...
			false,
			updateStatuses);
		return {ctor: '_Tuple2', _0: didUpdate, _1: spaces};
	});
var _user$project$Update$updateBoard = F2(
	function (point, model) {
		var nextMove = function () {
			var _p2 = model.nextMove;
			if (_p2.ctor === 'Cross') {
				return _user$project$Models$Circle;
			} else {
				return _user$project$Models$Cross;
			}
		}();
		var _p3 = _elm_lang$core$List$unzip(
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$Update$updateRow, point, model.nextMove),
				model.board));
		var updateStatuses = _p3._0;
		var newBoard = _p3._1;
		var didUpdate = A3(
			_elm_lang$core$List$foldl,
			F2(
			...
			false,
			updateStatuses);
		return didUpdate ? _elm_lang$core$Native_Utils.update(
			model,
			{board: newBoard, nextMove: nextMove}) : model;
	});
var _user$project$Update$toSvgCoords = _elm_lang$core$Native_Platform.outgoingPort(
	'toSvgCoords',
	function (v) {
		return [v._0, v._1];
	});
var _user$project$Update$update = F2(
	function (msg, model) {
		var _p4 = msg;
		if (_p4.ctor === 'ReceiveSVGCoords') {
			var _p6 = _p4._0;
			var _p5 = model.winner;
			if (_p5.ctor === 'Just') {
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			} else {
				var updated = A2(_user$project$Update$updateBoard, _p6, model);
				var newWinner = _user$project$Update$detectWinner(updated);
				var p = A2(_elm_lang$core$Debug$log, 'point: ', _p6);
				return {
					ctor: '_Tuple2',
			...
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Update$toSvgCoords(_p4._0)
			};
		}
	});
var _user$project$Update$receiveSvgCoords = _elm_lang$core$Native_Platform.incomingPort(
	'receiveSvgCoords',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
...
var _user$project$View$renderCircle = F2(
	function (point, w) {
		var radius = ((w / 2) | 0) - 5;
		var _p0 = point;
		var x = _p0._0;
		var y = _p0._1;
		var centerX = x + ((w / 2) | 0);
		var centerXStr = _elm_lang$core$Basics$toString(centerX);
		var centerY = y + ((w / 2) | 0);
		var centerYStr = _elm_lang$core$Basics$toString(centerY);
		return {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$cx(centerXStr),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$cy(centerYStr),
						_1: {
							ctor: '::',
...
var _user$project$View$renderCross = F2(
	function (point, w) {
		var _p1 = point;
		var x = _p1._0;
		var y = _p1._1;
		...
		var bufferedX = x + 5;
		var bufferedY = y + 5;
		var newX = _elm_lang$core$Basics$toString((w + x) - 5);
		var newY = _elm_lang$core$Basics$toString((w + y) - 5);
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$svg$Svg$line,
				{
					...
					_0: _elm_lang$svg$Svg_Attributes$x1(
						_elm_lang$core$Basics$toString(bufferedX)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y1(
							_elm_lang$core$Basics$toString(bufferedY)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$x2(newX),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$y2(newY),
								_1: {
									ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$x1(newX),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y1(
								_elm_lang$core$Basics$toString(bufferedY)),
...
var _user$project$View$renderBoardSpace = function (space) {
	var _p2 = space.content;
	switch (_p2.ctor) {
		case 'Cross':
			return A2(
				_user$project$View$renderCross,
				{ctor: '_Tuple2', _0: space.x, _1: space.y},
				space.width);
		case 'Circle':
			return A2(
				_user$project$View$renderCircle,
				{ctor: '_Tuple2', _0: space.x, _1: space.y},
				space.width);
		default:
			var viewBoxStr = A2(
					...
					_elm_lang$svg$Svg$rect,
					{
						...
						_1: {
							...
							_0: _elm_lang$svg$Svg_Attributes$width(
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(space.width),
									'px')),
							_1: {ctor: '[]'}
						}
					},
...
var _user$project$View$renderBoard = F2(
	function (board, width) {
		var renderedSpaces = A2(
			_elm_lang$core$List$map,
			_user$project$View$renderBoardSpace,
			...
			_1: {
				...
				_0: A2(
					_elm_lang$svg$Svg$line,
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$x1(
							_elm_lang$core$Basics$toString(cellWidth * 2)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y1('0'),
							_1: {
		...
		return _elm_lang$core$List$concat(
			{
				ctor: '::',
				_0: verticals,
				_1: {ctor: '::', _0: horizontals, _1: renderedSpaces}
			});
	});
var _user$project$View$renderWinner = function (maybeWinner) {
	var _p3 = maybeWinner;
	if (_p3.ctor === 'Just') {
		var svgInner = F2(
			function (point, width) {
				var _p4 = _p3._0;
				if (_p4.ctor === 'Cross') {
					return A2(_user$project$View$renderCross, point, width);
				} else {
					return A2(_user$project$View$renderCircle, point, width);
				}
			});
		return A2(
			_elm_lang$html$Html$div,
...
var _user$project$View$renderHeadsUp = F2(
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 75 75'),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$width('75px'),
														_1: {ctor: '[]'}
													}
												},
												A2(
...
var _user$project$View$decodeClickLocation = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Models$OnTouch,
	A3(
		_elm_lang$core$Json_Decode$map2,
		F2(
			function (v0, v1) {
...
var _user$project$View$view = function (model) {
	var headUp = function () {
		var _p6 = model.winner;
		if (_p6.ctor === 'Just') {
			return A2(_user$project$View$renderHeadsUp, 'Winner!', _p6._0);
		} else {
			return A2(_user$project$View$renderHeadsUp, 'Up Next:', model.nextMove);
		}
	}();
	return A2(
									...
									_elm_lang$svg$Svg$svg,
									{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: A2(_elm_lang$svg$Svg_Events$on, 'click', _user$project$View$decodeClickLocation),
													_1: {ctor: '[]'}
												}
											}
										}
									},
									A2(_user$project$View$renderBoard, model.board, 100)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Update$receiveSvgCoords(_user$project$Models$ReceiveSVGCoords);
};
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Models$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Models.Msg":{"args":[],"tags":{"ReceiveSVGCoords":["( Float, Float )"],"OnTouch":["( Int, Int )"]}}},"aliases":{},"message":"Models.Msg"},"versions":{"elm":"0.18.0"}});
}
